export const references = [
  {
    ...
    name: "Family Siroyt",
    company : "Private",
    product: "Birth cards and wedding cards",
    review: "Stijn helped us tremendously with the design of our birth announcement cards and wedding invitation. He listens to your needs and comes up with well-developed ideas himself—very helpful! In addition, he is ready to make adjustments wherever necessary. I can only recommend his service.",
},
{
   id: 2,
    name: "Mitch Das",
...
},
{
   id: 3,
    name: "Linda Zaeske",
    company : "Student Interior Design and Interior Architecture | Whitecliffe University Berlin School of applied sciences",
