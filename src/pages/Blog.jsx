...
import { Github, Filter, FileText } from 'lucide-react';
import Card from '../components/ui/Card';
import Button from '../components/ui/Button';
import { blog as blogs, blogCategories } from '../data/blogs'; // renamed for clarity
...
const BlogPage = () => {
  ...
  return (
    <div className="min-h-screen pt-16">
      {/* SEO */}
      <Helmet>
        <title>Blog | Stijn Walravens Portfolio</title>
        <meta
          name="description"
          content="Explore Stijn Walravens' personal blog — sharing insights on coding, design, and career growth."
        />
        <meta property="og:title" content="Blog | Stijn Walravens Portfolio" />
        <meta
          property="og:description"
          content="Read Stijn Walravens' latest blog posts about development, design, and creative projects."
        />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://your-portfolio-url.com/blog" />
        <meta property="og:image" content="https://your-portfolio-url.com/img/blog-cover.png" />
      </Helmet>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-google-gray-600 max-w-2xl mx-auto">
              Thoughts, tutorials, and updates from my coding and design journey.
            </p>
          </motion.div>
                  ...
                  <Link to={`/blog/${blog.slug}`} className="block h-full">
                    <Card className="h-full group">
                      ...
                      <div className="flex-1 flex flex-col">
                        ...
                        <p className="text-google-gray-600 mb-4 flex-1 line-clamp-3">
                          {blog.description}
                        </p>
